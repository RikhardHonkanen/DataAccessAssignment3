...
namespace DataAccessAssignment3.Migrations
{
    ...
    [Migration("20211122152245_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScreeningTicket", b =>
                {
                    ...
                    b.HasKey("ScreeningsID", "TicketsID");

                    b.HasIndex("TicketsID");

                    b.ToTable("ScreeningTicket");
                });

            modelBuilder.Entity("DataAccessAssignment3.Screening", b =>
                {
                    b.HasOne("DataAccessAssignment3.Cinema", null)
                        .WithMany("Screenings")
                        .HasForeignKey("CinemaID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccessAssignment3.Movie", null)
                        .WithMany("Screenings")
            ...
            modelBuilder.Entity("ScreeningTicket", b =>
                {
                    b.HasOne("DataAccessAssignment3.Screening", null)
                        .WithMany()
                        .HasForeignKey("ScreeningsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccessAssignment3.Ticket", null)
                        .WithMany()
